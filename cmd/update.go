...
// update self-updates the firecrawl-cli binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/firecrawl-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update firecrawl-cli to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "firecrawl-cli-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "firecrawl-cli")
